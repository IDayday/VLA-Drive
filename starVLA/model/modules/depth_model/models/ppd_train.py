...
from starVLA.model.modules.depth_model.utils.diffusion.timesteps import Timesteps
from starVLA.model.modules.depth_model.utils.diffusion.schedule import LinearSchedule
from starVLA.model.modules.depth_model.utils.diffusion.sampler import EulerSampler
from starVLA.model.modules.depth_model.utils.diffusion.logitnormal import LogitNormalTrainingTimesteps
from starVLA.model.modules.depth_model.utils.transform import image2tensor, resize_1024, resize_1024_crop, resize_keep_aspect

from starVLA.model.modules.depth_model.models.depth_anything_v2.dpt import DepthAnythingV2
from starVLA.model.modules.depth_model.models.dit import DiT
from starVLA.model.modules.depth_model.models.loss import multi_scale_grad_loss
...
class PixelPerfectDepth(nn.Module):
    def __init__(
        ...
        if self.config.semantics_model == 'MoGe2':
            from starVLA.model.modules.depth_model.moge.model.v2 import MoGeModel
    ...
    def forward_train(self, batch: dict):
        ...
        pred = self.dit(x=x, semantics=semantics, timestep=timesteps, qwen_tokens=batch['qwen_token'])
