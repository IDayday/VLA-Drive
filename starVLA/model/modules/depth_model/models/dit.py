...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.qwen_proj = nn.Linear(2048, hidden_size)
        self.qwen_cross_attn = nn.MultiheadAttention(hidden_size, num_heads=8, batch_first=True)
    ...
    def forward(self, x=None, semantics=None, timestep=None, qwen_tokens=None, dropout=0.1):
        """
