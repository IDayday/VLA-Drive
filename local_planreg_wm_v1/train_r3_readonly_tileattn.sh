...
planreg_launch r3_readonly_tileattn "${seed}" \
  "agent.checkpoint_path=${BOOTSTRAP_CHECKPOINT}" trainer.params.max_epochs=8 \
  agent.planning_registers.attention_mode=read_only agent.vlm_config.tile_register_aggregation=thumbnail_query_attention \
