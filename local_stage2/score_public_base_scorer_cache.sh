...
output_root="${DRIVEVLA_PUBLIC_SCORER_LABELS:-${DRIVEVLA_STAGE2_RUN_ROOT}/scorer_pdms93/public_base_labels_full_v1}"
...
exec "${DRIVEVLA_PYTHON}" "${repo_root}/local_stage2/score_public_base_scorer_cache.py" \
